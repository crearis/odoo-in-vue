<template>
  <q-card class="row">
    ...
    <q-card-section class="fit">
      ...
      <Field name="partner_id" v-bind:record="record" :mode="clicked"/>
      <Field name="label_tasks" v-bind:record="record" :mode="clicked"/>
    </q-card-section>

    <q-card-section>
      <Field name="user_id" v-bind:record="record" :mode="clicked"/>
      <Field name="privacy_visibility" v-bind:record="record" :mode="clicked"/>
    </q-card-section>
